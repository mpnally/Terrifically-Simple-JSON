...
[developed over 3 millenia](https://en.wikipedia.org/wiki/History_of_the_Hindu-Arabic_numeral_system). Other notations for the same entity
...
Terrifically Simple JSON is not trying to define a new RDF format or a new data model—its only goal is

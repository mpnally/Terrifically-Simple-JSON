...
The only requirements of Terrifically Simple JSON are that you follow the 3 constraints above, and use the `_id` property to do express contstraint 1 explicitly. It really is that simple.

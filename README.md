...
I may be on shaky ground here. I do not think the 3 constraints indicate a new media type—the opposite, actually, they emphasize using JSON directly instead of using it to build you rowen media type—

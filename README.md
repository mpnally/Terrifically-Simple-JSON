...
corresponds to some entiry in the API data model. The `_id` property provides a direct way of saying which entity it is—its value is the URL of the entity. 
